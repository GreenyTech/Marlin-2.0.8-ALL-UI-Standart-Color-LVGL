...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_PREVENTION_BY_XYZ_MOVMENT 1
  #define HOTEND_IDLE_TIMEOUT_SEC (15*60)    // (seconds) Time without extruder movement to trigger protection
  #define HOTEND_IDLE_MIN_TRIGGER   130     // (°C) Minimum temperature to enable hotend protection //150
  #define BED_IDLE_MIN_TRIGGER   40     // (°C) Minimum temperature to enable hotend protection
...
#define HOMING_BUMP_DIVISOR { 4, 4, 16 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  60, 40 }, { 175 40 }, { 270,  40 }, { 270, 300}, { 175 300}, { 60, 300} }
  ...
  #define TRAMMING_POINT_NAME_5 "Back-Middle"
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LCD_INFO_MENU 1 //disable About Printer //might be needet
  ...
  #define SOUND_MENU_ITEM 0 //in the conifg menu. i 
  ...
  #define LCD_TIMEOUT_TO_STATUS 300000
    ...
    #if EITHER(HAS_MARLINUI_U8GLIB, TFT_COLOR_UI) // && !T2_STM32F446
  ...
  #define SD_FINISHED_RELEASECOMMAND "M17Z\nM84XYE\nM140S0"  // Use "M84XYE" to keep Z enabled so your bed stays in place
 ...
 */
  ...
  #define PAUSE_PARK_UN_RETRACT_FEEDRATE         1  // (mm/s) Initial retract feedrate.
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      850  // (mm) The length of filament for a complete unload.
                                                  ...
                                                  //TODO reduce Unload to avoid damage on the filament sensor
...
#define PREHEAT_GCODE_BEVORE_MEASUREMENT_IF_ALLREADY_WARM "G92 E0\nG1 E F500\nG1 E-16\nG28\n"
//#define PREHEAT_GCODE_BEVORE_MEASUREMENT "M190 S55\nM109 S215\nG92 E0\nG1 E F500\nG1 E-16\nG28"
...
//#define CLEAR_PRINT_BEHAVIOR_FOR_PREHEAT_GCODE_BEVORE_MEASUREMENT "M140 S55\nM104 S215"
#define CLEAR_PREHEAT_GCODE_BEVORE_MEASUREMENT "G1 E0\nM140 S0\nM104 S0\nM140 S55\nM104 S215" // "// TODO Warning might be problematic
//#define CLEAR_PREHEAT_GCODE_BEVORE_MEASUREMENT "G1 E0"
#else

#define CLEAR_PRINT_BEHAVIOR_FOR_PREHEAT_GCODE_BEVORE_MEASUREMENT ""
#define CLEAR_PREHEAT_GCODE_BEVORE_MEASUREMENT "G1 E0\nM140 S0\nM104 S0"//\nM140 S55\nM104 S215" // 
#endif

//#define DOUBLE_CLEANING_POSITION_MENUE

#define INITIAL_GCODE_COMMANDS "G91\nG0 Z 0.007\nG0 Z -0.007\nG90"