...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_PID_AUTOTUNE_NOZZLE             = _UxGT("PID Autotune Nozzle");
  ...
  PROGMEM Language_Str MSG_ZPROBE_ZOFFSET_BLIND            = _UxGT("Z Offset (first layer only)"); // TODO hinzugefuegt.
  ...
  PROGMEM Language_Str MSG_SPEED_BETT_STABILISE                           = _UxGT("Startspeed for better adhesion");
