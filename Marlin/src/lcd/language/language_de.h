...
namespace Language_de {
  ...
  PROGMEM Language_Str MSG_ZPROBE_ZOFFSET_SET              = _UxGT("Neuer Z Offset (+0.15 Papier): "); 
  ...
  PROGMEM Language_Str MSG_SPEED_BETT_STABILISE                           = _UxGT("Anfangsgeschw. für Betthaftung");
  
  //PROGMEM Language_Str MSG_SPEED_RESET_AFTER_LAYERS                       = _UxGT("Geschw. automatisch zurück auf 100%");
  ...
  PROGMEM Language_Str MSG_BUTTON_HEAT_UP_NOZZLE_PARKPOSITION_VALUES_2 = _UxGT("Achtung Homen"); 
  PROGMEM Language_Str MSG_BUTTON_HEAT_UP_NOZZLE_PARKPOSITION_VALUES = _UxGT("Reinigunsprozess Düse"); 
