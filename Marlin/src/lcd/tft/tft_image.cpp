...
const tImage NoLogo                 = { nullptr, 0, 0, NOCOLORS };
  ...
  const tImage MarlinLogo150x113x16  = { (void *)marlin_logo_150x113x16,  150,  113, HIGHCOLOR };
...
const tImage Images[imgCount] = {
  TERN(SHOW_BOOTSCREEN, TERN(BOOT_MARLIN_LOGO_SMALL, MarlinLogo150x113x16, MARLIN_LOGO_FULL_SIZE), NoLogo),
  HotEnd_64x64x4,
  Bed_64x64x4,
  Bed_Heated_64x64x4,
  Chamber_64x64x4,
